...
def init_args():
    ...
    parser.add_argument('--video_path', type=str, help='The image path or the src image save dir')
...
def test_lanenet(video_path, weights_path, net_flag='enet'):
    """
    ...
    with sess.as_default():
        ...
        while(cap.isOpened()):
            ...
            #cv2.imshow('source_image',  postprocess_result['source_image'])
            #cv2.imshow('binary_mask', binary_seg_image[0] * 255)
